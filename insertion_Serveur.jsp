            ...
            <div class="col container">
                ...
                <div class="col-md-4 panel-body">
                    <section class="contact-clean">
                        <form action="../Serveur/enregistrer.do" method="post">
                            <h3 class="text-center">Ajout d'un nouveau serveur</h3>
                            <br>
                            <div class="form-group">
                                <label>IP</label>
                                <input class="form-control" type="texte"  name="ip" placeholder="Ip 0.0.0.0 du serveur" required>
                            </div>
                            <div class="form-group">
                                <label>Nom</label>
                                <input class="form-control" type="texte"  name="nom" placeholder="Nom du serveur" required>
                            </div>
                            <div class="form-group">
                                <label>Port</label>
                                <input class="form-control" type="texte"  name="port" placeholder="Port du serveur tomcat" required>
                            </div>
                            <div class="form-group">
                                <label>Chemin</label>
                                <input class="form-control" type="texte"  name="path" placeholder="Chemin du serveur tomcat" required>
                            </div>
                            <div class="form-group">
